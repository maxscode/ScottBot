...
import com.gmail.maxarmour2.scottbot.utils.cmd.Listener;
import com.gmail.maxarmour2.scottbot.utils.database.SQLiteDataSource;
...
public class Scott {
    ...
    public Scott() throws LoginException, SQLException, InterruptedException {
        jda = JDABuilder
